...
Future<void> getIsonData(BuildContext context) async {
var response =
await http.get(Uri.parse(url), headers: {"Accept": "aplication/json"}); print (response.body);
setState(() {
...
return Container
padding: EdgeInsets .all(5.0), child: Column( children: [
GestureDetector
onTap: () {
...
child: Padding(
padding: EdgeInsets.all(16.0), child: Row children: [ ClipRRect
child: Image.network( data! [index]["avatar"], height: 80, width: 80,
),
),
SizedBox (width: 10),
Column(
